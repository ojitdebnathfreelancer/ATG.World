                ...
                <div className='modalbody'>
                    ...
                    <div className='form-div d-flex justify-content-between'>
                        <div className='w-100 w-lg-50 main-form'>
                            ...
                            <input className='w-50 p-2' type='text' placeholder='First Name'></input>
                            <input className='w-50 p-2' type='text' placeholder='Last Name'></input>
                        ...
                        <div className='w-lg-50 img-div d-none d-lg-block'>
                            <p className='fp text-end'>Already have an account?<span className='sing-color' onClick={() => {
                                setOpen2(true)
                                setOpen(false)
                            }}>Sign In</span></p>
